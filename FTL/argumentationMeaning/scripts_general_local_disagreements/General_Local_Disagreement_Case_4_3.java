...
public class General_Local_Disagreement_Case_4_3 {
	...
	public static void main(String[] args) throws Exception {
		...
		Concept adamSphynx = new Concept(new Sign("solution:bird"), new HashSet<>(), new HashSet<>());
		...
		//adamSphynx.intensional_definition.addAll(adamMammal.intensional_definition());
		//adamSphynx.intensional_definition.addAll(adamFish.intensional_definition());
		adamSphynx.intensional_definition.addAll(adamBird.intensional_definition());
		...
		//adamSphynx.addExamples(adamMammal.extensional_definition());
		//adamSphynx.extensional_definition.addAll(adamFish.extensional_definition());
		adamSphynx.extensional_definition.addAll(adamBird.extensional_definition());
