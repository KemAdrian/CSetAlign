...
public class General_Local_Disagreement_Case_2 {
	...
	public static void main(String[] args) throws Exception {
		...
		//bobyChimera.addExamples(bobyMammal.extensional_definition());
		...
		//bobySphynx.addExamples(bobyBird.extensional_definition());
