...
public class SandboxBoundaryFixOverlap {
	...
	public static void main(String[] args) throws Exception {
		...
		adamChimera.intensional_definition.addAll(adamBird.intensional_definition());
		...
		adamChimera.extensional_definition.addAll(adamBird.extensional_definition());
